...
const endpoints = {
  ...
  total: (offerId) =>
    `/data/applications?where=jobId%3D%22${offerId}%22&distinct=_ownerId&count`,
  own: (offerId, userId) =>
    `/data/applications?where=jobId%3D%22${offerId}%22%20and%20_ownerId%3D%22${userId}%22&count`,
};
